...
fn test1_960() {
    ...
    assert_eq!(min_deletion_size(vec_string!["babca", "bbazb"]), 3);
    assert_eq!(min_deletion_size(vec_string!["edcba"]), 4);
    assert_eq!(min_deletion_size(vec_string!["ghi", "def", "abc"]), 0);
}
